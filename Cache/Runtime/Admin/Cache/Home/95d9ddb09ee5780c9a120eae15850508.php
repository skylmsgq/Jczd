...
function submitForm(action) {
    $(".submit").click(function(){
        commonAjaxSubmit("/Jczd/admin.php/Home/Fields/" + action);
        return false;
    });
}
...
$(function(){
    ...
    $("#check_field_name").click(function(){
        $.getJSON("/Jczd/admin.php/Home/Fields/checkFieldName", { field_name: $("#field_name").val(), model_id: "<?php echo ($model['id']); ?>", field_id: "<?php echo ($field['id']); ?>" }, function(json){
            $("#check_field_name").css("color",json.status==1?"#0f0":"#f00").html(json.info);
        });
    });

    $("#check_field_label").click(function(){
        $.getJSON("/Jczd/admin.php/Home/Fields/checkFieldLabel", { field_label: $("#field_label").val(), model_id: "<?php echo ($model['id']); ?>", field_id: "<?php echo ($field['id']); ?>" }, function(json){
