...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Jczd/Public/Min/?f=/Jczd/Public/stylesheets/admin/base.css|/Jczd/Public/javascripts/admin/asyncbox/skins/default.css" />
</head>

<body class="loginWeb">
    <div class="loginBox">
        <div class="innerBox">
            <div class="logo"> <img style="margin-left:-40px;margin-top:-30px;" src="/Jczd/Public/images/admin/index-logo.png" /></div>
            <form>
                <div class="loginInfo">
                    <ul>
