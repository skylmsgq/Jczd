...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/gov/admin/Public/Min/?f=/gov/admin/Public/stylesheets/admin/base.css|/gov/admin/Public/javascripts/admin/asyncbox/skins/default.css" />
</head>

<body class="loginWeb">
    <div class="loginBox">
        <div class="innerBox">
            <div class="logo"> <img src="/gov/admin/Public/images/admin/logo.png" /></div>
            <form>
                <div class="loginInfo">
                    <ul>
