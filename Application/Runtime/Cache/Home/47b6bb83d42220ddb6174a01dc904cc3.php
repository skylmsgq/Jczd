...
<body>
    ...
    <div class="content">
        ...
        <div class="content_left">
            <div class="menu">
    <ul>
        <?php if(is_array($law)): foreach($law as $key=>$v): ?><li><a href="<?php echo U('Index/handleArticle',array('type'=>'law','id'=>$v['id']));?>" title=""><?php echo ($v["title"]); ?><span class='fr'><?php echo (date('Y-m-d H:i',$v["updated_at"])); ?></span></a>
